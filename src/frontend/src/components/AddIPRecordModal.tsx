...
export default function AddIPRecordModal({
  open,
  onClose,
  onSuccess,
}: AddIPRecordModalProps) {
  ...
  const validate = (): boolean => {
    ...
    else if (!isValidIP(ipAddress.trim()))
      newErrors.ipAddress = "Enter a valid IPv4 or IPv6 address.";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({
        submit: err?.message ?? "Failed to add record. Please try again.",
      });
    }
  };
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* IP Address */}
          <div>
            <label htmlFor="add-ip-address" style={labelStyle}>
              IP Address *
            </label>
            <input
              id="add-ip-address"
          ...
          {/* Owner */}
          <div>
            <label htmlFor="add-owner" style={labelStyle}>
              Owner / Organisation *
            </label>
            <input
              id="add-owner"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="add-country" style={labelStyle}>
                Country *
              </label>
              <input
                id="add-country"
            ...
            <div>
              <label htmlFor="add-city" style={labelStyle}>
                City *
              </label>
              <input
                id="add-city"
          ...
          {/* Registration Date */}
          <div>
            <label htmlFor="add-reg-date" style={labelStyle}>
              Registration Date *
            </label>
            <input
              id="add-reg-date"
