      ...
      >
        ...
        <div className="flex justify-center mb-5">
          <div
            ...
            style={{ backgroundColor: 'oklch(0.65 0.20 25 / 0.12)', border: '1px solid oklch(0.65 0.20 25 / 0.35)' }}
          >
            <AlertTriangle className="w-7 h-7" style={{ color: 'oklch(0.70 0.20 25)' }} />
          </div>
        </div>
        ...
        <p className="text-sm text-center mb-5" style={{ color: 'oklch(0.55 0 0)' }}>
        ...
        >
          <div className="flex items-center justify-between gap-2">
            <span className="text-xs font-mono" style={{ color: 'oklch(0.78 0.15 85)' }}>{ipAddress}</span>
            <span className="text-xs truncate max-w-[140px]" style={{ color: 'oklch(0.60 0 0)' }}>{owner}</span>
          </div>
        </div>
