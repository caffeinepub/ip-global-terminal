...
export default function Footer() {
  ...
  const appId = encodeURIComponent(typeof window !== 'undefined' ? window.location.hostname : 'ipgt-app');
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-serif text-lg font-bold text-white">IPGT</span>
            </div>
            <p className="text-sm text-white/50 leading-relaxed">
              Global Intellectual Property Registry — securing innovation on the blockchain.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/register" className="hover:text-gold-400 transition-colors">
                  Register IP
                </Link>
              </li>
              <li>
                <Link to="/database" className="hover:text-gold-400 transition-colors">
                  IP Database
                </Link>
              </li>
              <li>
                <Link to="/whitepaper" className="hover:text-gold-400 transition-colors">
                  Whitepaper
                </Link>
              </li>
            </ul>
