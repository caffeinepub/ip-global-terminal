      ...
      <section className="relative overflow-hidden" style={{ minHeight: '90vh' }}>
        ...
        <div className="relative z-20 flex flex-col items-center justify-center text-center px-4 py-32 min-h-[90vh]">
          ...
          <p className="text-lg sm:text-xl text-white/70 max-w-2xl mb-10 leading-relaxed">
            Register, verify, and protect your patents, trademarks, and copyrights on an immutable
            blockchain ledger. Instant global recognition with cryptographic proof of ownership.
          </p>
          ...
          <div className="w-full max-w-md flex flex-col gap-3 mb-12">
            ...
            <Link
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.border = '1.5px solid oklch(0.78 0.15 85 / 0.65)';
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 0 28px oklch(0.78 0.15 85 / 0.28)';
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.border = '1.5px solid oklch(0.78 0.15 85 / 0.30)';
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 0 20px oklch(0.78 0.15 85 / 0.15)';
              }}
            >
              <div className="flex items-center gap-3">
                <div
                  className="flex items-center justify-center w-9 h-9 rounded-lg"
                  style={{ backgroundColor: 'oklch(0.78 0.15 85 / 0.15)', border: '1px solid oklch(0.78 0.15 85 / 0.35)' }}
                >
                  <PenLine className="w-4 h-4" style={{ color: 'oklch(0.78 0.15 85)' }} />
                </div>
                <div className="text-left">
                  <p className="text-sm font-semibold" style={{ color: 'oklch(0.78 0.15 85)' }}>Register IP</p>
                  <p className="text-xs" style={{ color: 'rgba(255,255,255,0.45)' }}>Secure your IP on-chain</p>
                </div>
              </div>
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" style={{ color: 'oklch(0.78 0.15 85)' }} />
            </Link>
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{ backgroundColor: 'oklch(0.78 0.15 85 / 0.15)', border: '1px solid oklch(0.78 0.15 85 / 0.35)' }}
                >
                  <Search className="w-4 h-4" style={{ color: 'oklch(0.78 0.15 85)' }} />
                </div>
                <div className="text-left">
                  <p className="text-sm font-semibold" style={{ color: 'oklch(0.78 0.15 85)' }}>Search Database</p>
                  <p className="text-xs" style={{ color: 'rgba(255,255,255,0.45)' }}>Browse global IP records</p>
                </div>
              </div>
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" style={{ color: 'oklch(0.78 0.15 85)' }} />
            </Link>
          ...
          <div className="grid grid-cols-3 gap-8 sm:gap-16 text-center">
            {[
              ...
              <div key={stat.label}>
                <div className="text-2xl sm:text-3xl font-serif font-bold text-gold-400">{stat.value}</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 max-w-xl mx-auto">
              The most secure and transparent intellectual property registry, powered by Internet Computer blockchain technology.
            </p>
          </div>
      ...
      <section className="py-24 px-4 bg-black/80 border-t border-gold-900/20">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 max-w-xl mx-auto">
              Three simple steps to secure your intellectual property on the blockchain.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                <h3 className="font-serif text-xl font-bold text-gold-400 mb-3">{cat.title}</h3>
                <p className="text-white/55 text-sm mb-5 leading-relaxed">{cat.desc}</p>
      ...
      <section className="py-24 px-4 bg-black border-t border-gold-900/20">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-serif text-4xl font-bold text-white mb-5">
            Ready to Protect Your <span className="text-gold-400">Innovation</span>?
          </h2>
          <p className="text-white/60 mb-10 text-lg">
            Join the global IP registry and secure your intellectual property on the blockchain today.
          </p>
          <Link
            to="/register"
