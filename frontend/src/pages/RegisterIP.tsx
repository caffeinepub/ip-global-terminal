...
import { Shield, Upload, FileText, Hash, AlertCircle, Loader2 } from 'lucide-react';
...
export default function RegisterIP() {
  ...
  const inputStyle: React.CSSProperties = {
    ...
    border: '1px solid oklch(0.25 0.02 85 / 0.5)',
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onBlur={(e) => { (e.target as HTMLInputElement).style.borderColor = 'oklch(0.25 0.02 85 / 0.5)'; }}
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onFocus={(e) => { (e.target as HTMLTextAreaElement).style.borderColor = 'oklch(0.78 0.15 85 / 0.7)'; }}
                onBlur={(e) => { (e.target as HTMLTextAreaElement).style.borderColor = 'oklch(0.25 0.02 85 / 0.5)'; }}
              />
            </div>
            ...
            <div>
              ...
              <div
                ...
                style={{
                  border: `2px dashed ${dragOver ? 'oklch(0.78 0.15 85)' : 'oklch(0.25 0 0)'}`,
                  backgroundColor: dragOver ? 'oklch(0.78 0.15 85 / 0.05)' : 'oklch(0.09 0 0)',
                }}
              ...
              >
                ...
                {file ? (
                  ...
                  <div>
                    <Upload className="w-8 h-8 mx-auto mb-2" style={{ color: 'oklch(0.40 0 0)' }} />
                    <p className="text-sm" style={{ color: 'oklch(0.55 0 0)' }}>
              ...
              {fileHash && (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs font-mono break-all" style={{ color: 'oklch(0.65 0 0)' }}>{fileHash}</p>
                  </div>
                </div>
              )}
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3.5 rounded-lg font-semibold text-sm transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
              style={{
              ...
              onMouseEnter={(e) => {
                if (!registerMutation.isPending) {
                  ...
                  (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 25px oklch(0.78 0.15 85 / 0.35)';
                }
              }}
              onMouseLeave={(e) => {
